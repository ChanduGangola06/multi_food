...
import 'package:multi_food/views/widgets/selection_button.dart';
import 'package:multi_food/views/widgets/top_foodies_user_row.dart';

class TopFoodieScreen extends StatefulWidget {
  const TopFoodieScreen({super.key});

  @override
  State<TopFoodieScreen> createState() => _TopFoodieScreenState();
}

class _TopFoodieScreenState extends State<TopFoodieScreen> {
  var selectTab = 0;
